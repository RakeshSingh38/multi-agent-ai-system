...
def init_session_state():
    """Initialize session state variables - Simplified for performance."""
    defaults = {
...
def set_template(template_key, templates):
    """Set the selected template and update session state - Simplified."""
...
def store_research_result(result):
    """Store research result in session state - Simplified."""
    st.session_state.update({
